import {validarCampos, validarCorreo, remover, validarLetras, validarNumero, validarKey, validarPoliticas, is_valid} from "./module.js"
...
$formulario.addEventListener("submit", (event) => {is_valid(event, "form > [required]")})
